...
<html lang="en">
    ...
    <head>
		...
		<link rel="stylesheet" href="resources/css/manage_test_form-elements.css">
        <link rel="stylesheet" href="resources/css/manage_test_style.css">
	                             ...
	                             <div class="form-bottom" id="form-box-left">
				                    <form role="form" action="" method="post" class="login-form">
				                        ...
				                        <div class="form-group">
				                        	...
				                        	<b>최대 할인 금액</b><input type="text" name="max-sale" placeholder="내용을 입력해주세요..." class="form-password form-control" id="max-sale">
				                        </div>
				                    </form>
			                    </div>
		                    </div>
