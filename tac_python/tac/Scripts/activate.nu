...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\BIFF2020\Documents\TAC(Try And Choice)\tac_python\tac'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\BIFF2020\Documents\TAC(Try And Choice)\tac_python\tac\Scripts\deactivate.nu'
